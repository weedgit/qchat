...
const CODE_TO_KEY: Record<string, MessageKey> = {
  ...
  enterprise_name_taken: "admin.enterprises.errNameTaken",
  invite_code_taken: "admin.enterprises.errInviteTaken",
  admin_create_failed: "api.err.conflict",
  delete_failed: "api.err.deleteFailed",
  request_failed: "login.requestFailed",
  network_error: "api.err.network",
  mfa_required: "admin.err.mfaRequired",
  mfa_invalid: "admin.err.mfaInvalid",
  ip_not_allowed: "admin.err.ipNotAllowed",
  busy: "admin.err.backupBusy",
  confirm_required: "admin.err.confirmRestore",
  invalid_backup_id: "admin.err.invalidBackupId",
  platform_owner_required: "admin.err.platformOwnerRequired",
...
const MESSAGE_TO_KEY: Array<[RegExp, MessageKey]> = [
  ...
  [/company name already exists/i, "admin.enterprises.errNameTaken"],
  [/invite code already/i, "admin.enterprises.errInviteTaken"],
  [/admin phone already registered/i, "admin.enterprises.errAdminPhoneTaken"],
  ...
  [/reason required/i, "admin.err.reasonRequired"],
  [/platform owner required/i, "admin.err.platformOwnerRequired"],
  [/backup or restore already running/i, "admin.err.backupBusy"],
  [/production restore requires/i, "admin.err.confirmRestore"],
  [/invalid backup id/i, "admin.err.invalidBackupId"],
  [/backup not found/i, "admin.err.backupNotFound"],
  [/insufficient role/i, "api.err.forbidden"],
  [/request not found/i, "api.err.notFound"],
