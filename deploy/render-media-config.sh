...
LIVEKIT_URL=${SCHEME}://${HOST}:7880
LIVEKIT_API_KEY=${API_KEY}
LIVEKIT_API_SECRET=${API_SECRET}
NEXT_PUBLIC_LIVEKIT_URL=${SCHEME}://${HOST}:7880
EOF
...
Next:
  ...
  # API: source or EnvironmentFile deploy/generated/media.env
  # Web (dev): export NEXT_PUBLIC_LIVEKIT_URL from media.env before npm run dev
EOF
