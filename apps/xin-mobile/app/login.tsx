      ...
      <View style={styles.hero}>
        <SafeAreaView edges={["top"]}>
          <View style={styles.brandMark}>
            <Text style={styles.brandMarkLetter}>{APP_LOGO_LETTER}</Text>
          </View>
...
function makeStyles(c: ColorTokens) {
  return {
    ...
    brandMarkLetter: { color: "#fff", fontSize: 28, fontWeight: "800" as const },
    brand: { color: "#fff", fontSize: 32, fontWeight: "800" as const },
