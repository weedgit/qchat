...
param(
  [string]$ApiUrl = "https://xinchat.boostbunny.io",
  [string]$LivekitUrl = "wss://xinchat.boostbunny.io:7443",
  [string]$OutName = "xinchat-mobile-preview.apk"
)
...
$env:XINCHAT_TRUST_CERT = "0"
$env:XINCHAT_ALLOW_CLEARTEXT = "0"

Write-Host "==> XinChat preview APK"
